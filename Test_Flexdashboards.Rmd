...
output$hover_info <- renderUI({
  ...
  for (i in 1:length(input$explore_variables)){
    ...
    panel_input <- paste0(panel_input,input$explore_variables[i],": ",eval(parse(text=paste0("point$X",filter(data_attributes, Series_Name==input$explore_variables[i])$Series_Code))),"<br/>")
  }
